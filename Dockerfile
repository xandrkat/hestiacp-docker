...
RUN php /usr/src/patch-hst-install-ubuntu.sh
...
COPY src/fix-phppgadmin.sh /usr/src/fix-phppgadmin.sh
RUN chmod +x /usr/src/fix-phppgadmin.sh
RUN php /usr/src/fix-phppgadmin.sh
